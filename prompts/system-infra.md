...
- technicalThing must be 4–5 words max — concise enough to fit on a card. Example: "designing a landing zone" not "designing an Azure landing zone with hub-spoke topology."
